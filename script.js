...
void main() {
  const vec3 c1 = vec3(0.153,0.31,0.086); // Escala de verde
  const vec3 c2 = vec3(0.133,0.267,0.075); // Escala de verde
  const vec3 c3 = vec3(0.11,0.224,0.063); // Escala de verde
  const vec3 c4 = vec3(0.086,0.176,0.047); // Escala de verde
